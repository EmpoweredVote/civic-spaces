 ...
 */
export function extractDisplayName(censusName: string): string {
...
/**
 * Calls the free Census Bureau FIPS API to get a county's or place's
 * canonical name. Free API, no key required.
 */
...
/**
 * Returns the human-readable jurisdiction name for a slice's hero pill.
 *
 * Resolution:
