...
import { isMockSliceId } from '../lib/devMockData'
 ...
 * apart by member-cap sharding — see services/slice-assignment). Used to
...
export function useSiblingSlices(
  ...
  if (mock) {
    return {
      siblings: [{ id: ownSliceId, siblingIndex: ownSiblingIndex, memberCount: ownMemberCount }],
      isLoading: false,
      isError: false,
    }
  }
