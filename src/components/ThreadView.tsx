    ...
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="flex-1 px-4 pb-8">
        ...
        {/* 2. Join the conversation — hidden when browsing a sibling slice
            read-only; otherwise always visible, since anonymous clicks are
            caught by requireAuth in handleReplyToPost, which opens the
            login prompt instead of ever setting replyComposerOpen. */}
        {isViewOnly ? (
