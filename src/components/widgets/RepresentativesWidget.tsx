    ...
    return (
      <WidgetCard title="Representing This Community">
        <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
          Representative information isn't available for this address yet.
          Sign in and verify your address to see your real elected officials.
        </p>
      </WidgetCard>
    )
  }
  ...
  return (
    <WidgetCard title="Representing This Community">
      {primaryRep && (
        ...
        >
          Your alignment and local discussions on this page are most closely
          connected to{' '}
      ...
      {missingFederalLegislature && (
        <p className="mt-3 text-xs text-gray-400 dark:text-gray-500 leading-relaxed">
          Your Senators and U.S. Representative aren't available yet. Sign in
          and verify your address to see all of your federal officials.
        </p>
      )}
    </WidgetCard>
  )
