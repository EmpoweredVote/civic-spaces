      ...
      <div className="max-h-[60vh] overflow-y-auto">
        ...
        {!isLoading && notifications.length === 0 && (
          <div className="flex flex-col items-center justify-center py-10 px-6 text-center gap-2">
            ...
            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">You're all caught up</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Replies and friend activity will appear here</p>
          </div>
        )}
